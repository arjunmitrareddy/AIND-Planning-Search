...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in actions:
            ...
            if action_node.prenodes.issubset(prev_s_level):
                for s_level_node in prev_s_level:
                    s_level_node.children.add(action_node)
                    action_node.parents.add(s_level_node)
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        return node_a1.action.effect_add and node_a2.action.effect_rem or \
               node_a2.action.effect_add and node_a1.action.effect_rem
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        return node_a1.action.effect_add and node_a2.action.precond_neg or \
               node_a1.action.effect_rem and node_a2.action.precond_pos or \
               node_a2.action.effect_add and node_a1.action.precond_neg or \
               node_a2.action.effect_rem and node_a1.action.precond_pos
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        for s1_p in node_s1.parents:
            for s2_p in node_s2.parents:
                if not s1_p.is_mutex(s2_p):
                    return False
        return True
